...
This project is a template to start your own Vert.x 3 project using Gradle.
...
----
java -jar build/libs/vertx-gradle-starter-1.0-SNAPSHOT-fat.jar -conf conf.json
----

-----------
This project shows how to use the Vert.x 3.3 redeploy feature. Vert.x watches for file changes and will then compile these changes. The hello world verticle will be redeployed automatically.
